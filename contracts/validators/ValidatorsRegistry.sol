...
contract ValidatorsRegistry is Initializable {
    ...
    * _entityId - ID of the collector's entity where the deposit was accumulated.
    * _stakingDuration - Staking duration of the validator.
    */
    function register(bytes calldata _pubKey, uint256 _entityId, uint256 _stakingDuration) external {
