...
contract ValidatorsRegistry is Initializable {
    ...
    */
    function register(bytes calldata _pubKey, uint256 _entityId) external onlyCollectors {
    ...
    * @param _entityId - ID of the collector's entity, the Validator should be updated to.
    */
